...
<head>
	...
	@media (max-width:992px){.mnsk7-header__inner{overflow:hidden;overflow-x:hidden}.mnsk7-header__nav .mnsk7-header__menu{display:none!important}.mnsk7-header__nav.is-open .mnsk7-header__menu{display:flex!important}.mnsk7-header__menu-toggle{display:flex!important;align-items:center;justify-content:center;min-width:44px;min-height:44px}#mnsk7-header-search.mnsk7-header__search-dropdown{display:none!important}.mnsk7-header__search-toggle{display:inline-flex!important;align-items:center;justify-content:center;min-width:44px;min-height:44px}}
	</style>
</head>
<body <?php body_class(); ?>>
<?php
