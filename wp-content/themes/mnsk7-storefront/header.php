		...
		<div class="mnsk7-header__actions">
			...
			<div class="mnsk7-header__search-wrap">
				<form role="search" method="get" class="mnsk7-header__search-form mnsk7-header__search-form--inline" action="<?php echo esc_url( home_url( '/' ) ); ?>" hidden aria-hidden="true">
					...
					<input type="search" id="mnsk7-header-search-input" class="mnsk7-header__search-input" placeholder="<?php esc_attr_e( 'Szukaj produktów…', 'mnsk7-storefront' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" autocomplete="off" />
				...
				<div id="mnsk7-header-search" class="mnsk7-header__search-dropdown" hidden>
					<form role="search" method="get" class="mnsk7-header__search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						...
						<input type="search" id="mnsk7-header-search-input-mobile" class="mnsk7-header__search-input" placeholder="<?php esc_attr_e( 'Szukaj produktów…', 'mnsk7-storefront' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" />
						<input type="hidden" name="post_type" value="product" />
